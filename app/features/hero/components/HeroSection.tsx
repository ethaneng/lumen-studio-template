...
export default function HeroSection() {
  ...
  return (
    <section ref={sectionRef} className="relative h-screen overflow-hidden">
      ...
      {/* Hero Content */}
      <div className="relative z-10 flex items-center justify-start h-full container px-28 mx-auto ">
        <div className="text-white px-4 w-1/2 relative z-10">
          <h1
            ref={headingRef}
            className="font-heading text-4xl md:text-5xl lg:text-6xl xl:text-7xl xl:leading-24 font-bold mb-8 drop-shadow-sm"
          >
            Defining Moments <br />
            Through the Lens
          </h1>
          <p
            ref={paragraphRef}
            className="mb-12 text-2xl text-muted line-clamp-4 max-w-xl drop-shadow-sm"
          >
        ...
        <Image
          ...
          className="grayscale absolute right-28 top-1/2 -translate-y-1/2 w-[992px]"
          placeholder="blur"
          ...
          quality={85}
          sizes="(max-width: 640px) 300px, (max-width: 1024px) 450px, 992px"
          priority
        />
      </div>
